...
const Login = () => {
  return (
    <div className='min-h-screen flex flex-col md:flex-row'>
      ...
      {/* LEFT SIDE (logo + text) */}
      <div className="flex-1 flex flex-col items-start justify-center p-6 md:p-10">
        <div className='flex items-center gap-3 mb-4 max-md:mt-10'>
          <img src={assets.group_users} alt="" className='h-20 md:h-24'/>
          <div>
            <div className='flex'>
